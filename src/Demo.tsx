  ...
  const renderTopRightUI = (isMobile: boolean) => {
    return (
      <>
        ...
        <button style={{ height: '2.5rem' }} onClick={() => alert('This is dummy top right UI')}>
          {' '}
          Click me{' '}
        </button>
      </>
  ...
  return (
    <div ref={appRef} className="App">
      ...
      <button
        onClick={() => {
          excalidrawAPI?.updateScene({
            elements: produce(excalidrawAPI?.getSceneElements(), draft => {
              draft[0].customData = { global: 'true', beh: [{ type: 'chert' }] };
            }),
          });
          ...
          // });
          // getSceneElements[0].customData = { global: 'true', beh: [{ type: 'chert' }] };
      ...
      <div className="button-wrapper">
        ...
        <label>
          <input checked={viewModeEnabled} type="checkbox" onChange={() => setViewModeEnabled(!viewModeEnabled)} />
          View mode
        </label>
        <label>
          <input checked={zenModeEnabled} type="checkbox" onChange={() => setZenModeEnabled(!zenModeEnabled)} />
          Zen mode
        </label>
        <label>
          <input checked={gridModeEnabled} type="checkbox" onChange={() => setGridModeEnabled(!gridModeEnabled)} />
          Grid mode
        </label>
        <label>
          <input
      ...
      <div className="excalidraw-wrapper">
        ...
        >
          <button
            onClick={() => {
              ...
              return excalidrawAPI?.toggleSidebar((...args) => !!void console.log({ args }));
            }}
          >
        ...
        <Excalidraw
          ...
          // onPointerUpdate={setPointerData}
      ...
      <div className="export-wrapper button-wrapper">
        ...
        <label className="export-wrapper__checkbox">
          <input checked={exportEmbedScene} type="checkbox" onChange={() => setExportEmbedScene(!exportEmbedScene)} />
